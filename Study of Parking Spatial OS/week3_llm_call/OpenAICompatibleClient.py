...
class OpenAICompatibleClient:
    ...
    def generate(self, prompt: str = "", system_prompt: str = "", strip_think: bool = True) -> str:
        """调用 LLM，返回文本内容。"""
...
if __name__ == "__main__":
    ...
    answer = client.generate(prompt=user_prompt, system_prompt=system_prompt)
    print("模型返回：", answer)
